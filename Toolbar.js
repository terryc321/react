...
class Toolbar  extends React.Component {
	...
	return (
		...
		<div className="toolbar-logo"> <a href="#" onClick={this.openSideMenu}>
		...
		<a href="#" className="btn-close" onClick={this.closeSideMenu}>&times;</a>
		<a href="#Home">Home</a>
		...
		<p>YOU don't know about me without you have read a book by the name of The
...
is mostly a true book, with some stretchers, as I said before. </p>
...
juice kind of waps around, and the things go better.</p>
...
was all right, because she done it herself.</p>

<p>Her sister, Miss Watson, a tolerable slim old maid, with goggles on,
